...
class NearSocialdisterFragment : Fragment() {
    ...
    private var _binding: NearSocialDisaterFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = NearSocialDisaterFragmentBinding.inflate(inflater, container, false)
    ...
    private fun initMap() {
        val mapFragment =
            childFragmentManager.findFragmentById(R.id.socialDisterFragment) as SupportMapFragment
