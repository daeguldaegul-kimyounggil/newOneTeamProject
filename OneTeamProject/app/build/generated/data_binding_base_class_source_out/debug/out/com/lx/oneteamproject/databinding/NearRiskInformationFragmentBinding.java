...
public final class NearRiskInformationFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static NearRiskInformationFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NearRiskInformationFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.near_risk_information_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NearRiskInformationFragmentBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.riskInformationFragment;
      FragmentContainerView riskInformationFragment = ViewBindings.findChildViewById(rootView, id);
      if (riskInformationFragment == null) {
        break missingId;
      }
